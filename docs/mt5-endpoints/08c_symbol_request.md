# SymbolRequest - Fetch Symbol Configuration Directly from Server
...
Fetches symbol configuration directly from the trade server.
...
```python
sym = manager.SymbolRequest("EURUSD")
