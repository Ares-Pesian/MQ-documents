# GroupRequest - Retrieve a Single Group Configuration
...
Fetches a single group's full configuration from the server.
...
```python
group = manager.GroupRequest("managers\administrators")
